...
import com.gestion.exception.RecourseNotFoundException;
import com.gestion.repositorio.ClienteRepository;
...
public class ClienteController {
	...
	public ResponseEntity<Cliente> listarClienteId(@PathVariable Long id){
		Cliente cliente = clienteRepository.findById(id)
				.orElseThrow(() -> new RecourseNotFoundException("EL cliente con ese ID no existe : " + id));
